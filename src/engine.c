...
//    tilescreen = SDL_CreateRGBSurface(SDL_SWSURFACE, 20 * 16 * scaling, 12 * 16 * scaling, bitdepth, 0, 0, 0, 0);
//    SDL_SetColorKey(tilescreen, SDL_SRCCOLORKEY|SDL_RLEACCEL, 0); //Set transparent colour
