...
extern bool L_SCROLL(TITUS_level *level);
extern bool R_SCROLL(TITUS_level *level);
extern bool U_SCROLL(TITUS_level *level);
extern bool D_SCROLL(TITUS_level *level);
