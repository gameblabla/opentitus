...
int GAL_FORM(TITUS_level *level, TITUS_enemy *enemy);
    ...
    for (i = 0; i < level->enemycount; i++) {
        ...
        case 6:
            ...
            case 1:
                ...
                //Delay: Last Y position, reuse of the delay variable
                /*if (abs(level->enemy[i].sprite.y - level->enemy[i].delay) < level->enemy[i].rangeY) { 
                    continue;
                }*/
...
int GAL_FORM(TITUS_level *level, TITUS_enemy *enemy) { //Enemy animation
    int16 *image;
