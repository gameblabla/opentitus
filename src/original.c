...
int initoriginal() {
    ...
    if (game == 0) { //Titus
        ...
        for (i = 0; i < ANIM_PLAYER_MAX_MOKTAR; i++) { // Undefined behaviour at 12
	...
	orig_sky_colour[0] = 15; //On the foxy trail
	...
	orig_sky_colour[1] = 15; //Looking for clues
	...
	orig_sky_colour[2] = 15; //Road works ahead
	...
	orig_sky_colour[3] = 0; //Going underground
	...
	orig_sky_colour[4] = 0; //Flaming catacombes
	...
	orig_sky_colour[5] = 15; //Coming to town
	...
	orig_sky_colour[6] = 15; //Foxys den
	...
	orig_sky_colour[7] = 0; //On the road to Marrakesh
	...
	orig_sky_colour[8] = 0; //Home of the pharaohs
	...
	orig_sky_colour[9] = 11; //Desert experience
	...
	orig_sky_colour[10] = 15; //Walls of sand
	...
	orig_sky_colour[11] = 11; //A beacon of hope
	...
	orig_sky_colour[12] = 15; //A pipe dream
	...
	orig_sky_colour[13] = 15; //Going home
	...
	orig_sky_colour[14] = 15; //Just married/Direction Barbes
	...
	orig_sky_colour[15] = 15; //Just married
