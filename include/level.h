...
struct _TITUS_spritedata {
    ...
    int16 refheight;
    uint8 refwidth;
    int16 height; //Height, used by the engine (if scaled 2x, this will be the same, data->h will be doubled)
    uint8 width; //Width, used by the engine (if scaled 2x, this will be the same, data->w will be doubled)
